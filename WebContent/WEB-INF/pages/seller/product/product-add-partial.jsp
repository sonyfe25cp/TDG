...
<div>
	<form class="form-horizontal" method="post" action="/seller/product/addproduct">
		<legend><fmt:message key="seller.product.add.productdesc"/></legend>
		<div class="control-group">
			<label class="control-label">*<fmt:message key="product.model.name"/></label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">*<fmt:message key="product.model.mainimage"/></label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><fmt:message key="product.model.subimages"/></label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">*<fmt:message key="seller.product.add.parentOrNot"/></label>
			<div class="controls">
		    	<input type="radio" name="hasChildrenOrNot" value="no"><fmt:message key="seller.product.add.standAloneSKU"/>
		    	<input type="radio" name="hasChildrenOrNot" value="yes"><fmt:message key="seller.product.add.parentWithChildSKU"/>
		    </div>
		</div>
		<div id="standAloneSKU" class="hidden">
			<div class="control-group">
				<label class="control-label"><fmt:message key="item.model.sku"/></label>
				<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">*<fmt:message key="seller.product.add.internationalShippingService"/></label>
			<div class="controls">
		...
		<div class="hidden" id="internationalShippingService">
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.internationalShippingFee"/></label>
				<div class="controls">
			    	<input type="text" name="internationalShippingFee" access="float">
			    </div>
			</div>
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.internationalPromiseDays"/></label>
				<div class="controls">
		...
		<legend><fmt:message key="seller.product.add.productprices"/></legend>
		<div id="prices">
			<div class="control-group">
				<label class="control-label">*<fmt:message key="product.model.retailPrice"/></label>
				<div class="controls">
			    	<input type="text" name="retailPrice" access="float" autocomplete="on">
			    </div>
			</div>
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.promotionPrice"/></label>
				<div class="controls">
			    	<input type="text" name="promotionPrice" access="float" autocomplete="on">
			    </div>
			</div>
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.promotionTime"/></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.wholePrice"/></label>
				<div class="controls">
			    	<input type="text" name="wholePrice" access="float" autocomplete="on">
			    </div>
			</div>
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.minimumQuantity"/></label>
				<div class="controls">
			    	<input type="text" name="minimumQuantity" access="int">
			    </div>
			</div>
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.maximumAcceptQuantity"/></label>
				<div class="controls">
			    	<input type="text" name="maximumAcceptQuantity" access="int">
			    </div>
			</div>
			<div class="control-group">
				<label class="control-label">*<fmt:message key="product.model.availableQuantity"/></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.safeStock"/></label>
				<div class="controls">
			    	<input type="text" name="safeStock" access="int" value="5">
			    </div>
			</div>
		</div>
		<legend><fmt:message key="seller.product.add.productdescription"/></legend>
		<div id="others">
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.netWeight"/></label>
				<div class="controls">
					<input type="text" name="netWeight" access="text">
			    </div>
			</div>
			<div class="control-group">
				<label class="control-label">*<fmt:message key="product.model.grossWeight"/></label>
				<div class="controls">
					<input type="text" name="grossWeight" access="text">
			    </div>
			</div>
			<div class="control-group">
				<label class="control-label">*<fmt:message key="product.model.sizeWithPackage"/></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.brandId"/></label>
				<div class="controls">
					<select name="brandId">
							<option></option>
			...
			<div class="control-group">
				<label class="control-label"><fmt:message key="product.model.description"/></label>
				<div class="controls">
		...
		<div class="control-group">
			<div class="controls">
		    	...
		    	<a class="btn btn-primary" id="over_then_continue"><fmt:message key="button.product.addnext"/></a>
			    <a class="btn btn-info" id="over_then_addsub"><fmt:message key="button.product.addsub"/></a>
		    </div>
		</div>
