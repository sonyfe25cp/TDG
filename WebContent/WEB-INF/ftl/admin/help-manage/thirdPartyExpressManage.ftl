...
<div class="container">
  ...
  <div class="help-right">
     ...
     <div class="help-box">
         <form action="/admin/manageHelp/updateThirdPartyExpress">
               <div id="content">
                 <textarea id="thirdPartyExpress" rows="20" name="thirdPartyExpress" class="field span12" placeholder="input some description about this product"></textarea>
               </div>
               <div id="submit">
