...
<div class="container">
  ...
  <div class="help-right">
     ...
     <div class="help-box">
         <form action="/admin/manageHelp/updatePriceProtect">
               <div id="content">
                 <textarea id="priceProtect" rows="20" name="priceProtect" class="field span12" placeholder="input some description about this product"></textarea>
               </div>
               <div id="submit">
