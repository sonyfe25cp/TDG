...
<div class="container">
  ...
  <div class="help-right">
     ...
     <div class="help-box">
         <form action="/admin/manageHelp/updateFAQ">
               <div id="content">
                 <textarea id="FAQ" rows="20" name="FAQ" class="field span12" placeholder="input some description about this product"></textarea>
               </div>
               <div id="submit">
