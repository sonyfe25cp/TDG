...
<div class="container">
  ...
  <div class="help-right">
     ...
     <div class="help-box">
         <form action="/admin/manageHelp/updatePayOnline">
               <div id="content">
                 <textarea id="payOnline" rows="20" name="payOnline" class="field span12" placeholder="input some description about this product"></textarea>
               </div>
               <div id="submit">
