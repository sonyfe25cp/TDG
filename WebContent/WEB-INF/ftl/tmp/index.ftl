	...
	<div class="container-fluid">
		<div class="row-fluid">
		    <div class="span6">
				...
				<legend>12.21更新说明</legend>
				<h3>本次更新的内容</h3>
				<ul>
					<li>1. 发送邮件功能暂停发送，我的服务器持续发邮件会被封的</li>
					<li>2. 定时任务说明</li>
					<li>1). 关于自动关闭订单，目前是每1个小时监测一次，如果卖家已发货超过1天，则半点(如9:30,10:30)会自动关闭该订单至 用户已接收状态</li>
					<li>2). 自动财务，每天8:00会自动统计昨天一天的账目(0:00 -- 24:00)</li>
				</ul>
			...
			<div class="span6">
				<legend>重要逻辑记录</legend>
				<p>3.17 edwin test3:在今天的对账单中，属于退货订单的对账出现错误。订单526号被裁定退货退款20%，则商户退给平台的费用应该是商品的售价（1199.09元）*0.2,，为239.82元。而非系统中以折扣售价（1163.12元）*0.2.请修正。</p>
				<p>即：无理由退货退款用售价退款，而不是折后价退款。</p>
				<legend>0124更新说明</legend>
				<h3>本次更新的内容</h3>
				<ul>
					<li>1.系统语言固定，买家-中文，卖家-英文，管理员-中文</li>
					<li>2.各种调整</li>
				</ul>
			</div>
		</div>
